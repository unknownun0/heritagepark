        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {galleryAreas.map((item) => (
              <div key={item.label} className="group relative aspect-[4/3] bg-moss/10 rounded-lg overflow-hidden cursor-pointer">
                ...
                <p className="absolute bottom-0 left-0 right-0 p-5 text-white font-semibold opacity-0 group-hover:opacity-100 transition-opacity">
                  {item.label}
                </p>
              </div>
            ))}
