...
const galleryAreas = [
 ...
 { label: 'Memory Place', image: '/images/mortuary/20250219_145000.jpg', desc: 'A dedicated sanctuary within the park for quiet reflection and lasting tribute to those who havepassed.' },
