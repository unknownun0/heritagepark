  ...
  <>
   ...
   <section className="py-20 bg-cream">
    <div className="max-w-7xl mx-auto px-4 text-center">
     ...
     <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4 normal-case tracking-normal">
      Find the right memorial property for your family
     </h2>
     ...
     <Image src="/images/plan-ahead-hero.jpg" alt="Heritage Park Memorial Lots" className="mx-auto rounded-lg shadow-lg mb-8" width={700} height={150} />
     <Link
...
Planning ahead means more than choosing a memorial property. Explore our memorial plans and find the protection that best fits your family&apos;s needs.
      ...
      <Image src="/images/Heritage%20Park%20Funeral%20Services.jpg" alt="Heritage Park Funeral Services" className="mx-auto rounded-lg shadow-lg mb-8" width={700} height={150} />
      <Link
