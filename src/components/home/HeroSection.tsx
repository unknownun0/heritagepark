...
export default async function HeroSection() {
  ...
  const rightDesc = await getPageContent('home', 'hero_right_desc', 'We\'re here for your family in this moment. Call our 24/7 support line for immediate assistance.')
  const rightBtn = await getPageContent('home', 'hero_right_btn', 'Get Help Now')
  const rightHref = await getPageContent('home', 'hero_right_href', '/immediate-need')
