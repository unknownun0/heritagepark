    ...
    <div className="fixed inset-0 z-50 xl:hidden">
      ...
      <div className="absolute right-0 top-0 bottom-0 w-80 max-w-[85vw] bg-cream shadow-xl animate-slide-down">
        ...
        <div className="p-4 border-t border-primary/10">
          <a href="tel:+639178841009" className="block w-full bg-[#e2af43] text-primary text-center font-semibold py-3 rounded text-sm hover:bg-[#e2af43]/90 transition-colors">
            Call Us Now
          </a>
        </div>
      </div>
