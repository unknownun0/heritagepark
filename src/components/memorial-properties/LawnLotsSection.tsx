const tiers = [
 ...
 },
 {
  ...
  desc: 'Closer to the central pathways, with slightly wider spacing between markers. A step up in positioning while maintaining the same elegantsimplicity.',
 },
 {
   ...
   <section className="py-20 bg-white">
    <div className="max-w-3xl mx-auto px-4 text-center">
     ...
     <p className="text-primary/70 text-base leading-relaxed">
      A lawn lot is not a compromise it&apos;s a thoughtful entry point. Starting early means you secure today&apos;s pricing, lock in your preferred location, and give your family one less thing to worry about. You can always upgrade or add to your plan later. The most important step is simplybeginning.
     </p>
    </div>
   </section>
