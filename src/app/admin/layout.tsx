...
const navItems = [
 ...
 { href: "/admin/page-content", label: "Page Content", icon: "\u{1F4C4}" },
 { href: "/admin/blog-posts", label: "Blog Posts", icon: "\u{270F}" },
 { href: "/admin/media", label: "Media", icon: "\u{1F5BC}" },
 { href: "/admin/admins", label: "Admins", icon: "\u{1F512}" },
];
